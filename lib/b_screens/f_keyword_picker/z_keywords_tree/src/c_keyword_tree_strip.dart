...
class KeywordTreeStrip extends StatelessWidget {
  /// --------------------------------------------------------------------------
  const KeywordTreeStrip({
    required this.width,
    required this.level,
  ...
  Widget build(BuildContext context) {
    ...
    // --------------------
    /// NODE TRANSLATION
    String _translation = getWord(nodeKey);
    _translation = _translation == '' ? '...': _translation;
    // --------------------
        ...
        children: <Widget>[
          ...
          Builder(
            builder: (context) {
              ...
              return BldrsBox(
                maxWidth: _keyButtonMaxWidth - 10,
                height: _buttonHeight,
                corners: Borderers.constantCornersAll10,
                verse: Verse.plain(_translation),
                icon: StoragePath.phids_phid(nodeKey),
                bubble: false,
                ...
                onTap: () async {
                  ...
                  if (_isLastNode == true){
                    await onLastNodeTap.call();
                  }

                  else {
                    await onExpandableNodeTap.call();
                  }
