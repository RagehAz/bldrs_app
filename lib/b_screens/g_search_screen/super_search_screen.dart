...
import 'package:bldrs/b_screens/g_search_screen/views/search_view_splitter.dart';
import 'package:bldrs/b_screens/g_search_screen/z_components/building_blocks/search_type_button.dart';
import 'package:bldrs/b_screens/g_search_screen/z_components/filters_tiles/bz_search_filters_list.dart';
import 'package:bldrs/b_screens/g_search_screen/z_components/filters_tiles/flyer_search_filters_list.dart';
import 'package:bldrs/b_screens/g_search_screen/z_components/filters_tiles/users_search_filters_list.dart';
    ...
    if (_searchType == ModelType.flyer){
     return FlyersSearchFiltersList(
       ...
       onPickPhidTap: () async {
         ...
         final String? _phid = await KeywordsPickerScreen.pickPhid(
           onlyFlyerTypes: _searchModel?.flyerSearchModel?.flyerType == null ? null : [_searchModel!.flyerSearchModel!.flyerType!],
           onlyZone: _searchModel?.zone,
         );
