...
import 'package:bldrs/b_screens/g_search_screen/z_components/building_blocks/history_line.dart';
import 'package:bldrs/b_screens/g_search_screen/z_components/filters_tiles/zone_filter_tile.dart';
                  ...
                  child: Wrap(
                    ...
                    children: <Widget>[
                      ...
                      if (_model.flyerSearchModel?.phid != null)
                        HistoryLine(
                          /// proGetPhidIcon__issue
                          icon: null, // ChainsProvider.proGetPhidIcon(son: _model.flyerSearchModel?.phid,),
                          bigIcon: true,
                          verse: Verse(
                      ...
                      if (_model.bzSearchModel?.scopePhid != null)
                        HistoryLine(
                          /// proGetPhidIcon__issue
                          icon: null, // ChainsProvider.proGetPhidIcon(son: _model.bzSearchModel?.scopePhid,),
                          bigIcon: true,
                          verse: Verse(
                            translate: true,
