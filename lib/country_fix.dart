...
String xGetIso2(String countryID){
  String _iso2;
  final Map<String, dynamic> _map = getInternetCountries().singleWhere((map) => map['ISO3'] == countryID.toUpperCase());
  if (_map != null){
    _iso2 = _map['ISO2'];
  }
  return _iso2;
...
String xGetCountryName(String countryID){
  ...
  if (_iso2 != null){
    final Map<String, dynamic> _map = cocoNameIso2().singleWhere((map) => map['abbreviation'] == _iso2);
    if (_map != null){
...
int xGetPopulation(String countryID){
  ...
  if (countryID != null){
    ...
    if (_countryName != null){
      final Map<String, dynamic> _map = cocoNamePopulation().singleWhere((map) => map['country'] == _countryName);
      if (_map != null){
...
String xGetGov(String countryID){
  ...
  if (countryID != null){
    ...
    if (_countryName != null){
      final Map<String, dynamic> _map = cocoNameGov().singleWhere((map) => map['country'] == _countryName);
      if (_map != null){
