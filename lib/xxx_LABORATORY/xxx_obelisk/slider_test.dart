          ...
          children: <Widget>[
            ...
            SliderTheme(
              data: SliderTheme.of(context).copyWith(
                activeTickMarkColor: Colorz.BlackBlack,
                activeTrackColor: Colorz.BabyBlue,
                disabledActiveTickMarkColor: Colorz.Green,
                disabledActiveTrackColor: Colorz.GreenPlastic,
                disabledInactiveTickMarkColor: Colorz.White,
                disabledInactiveTrackColor: Colorz.BlackGlass,
                disabledThumbColor: Colorz.YellowGlass,
                inactiveTickMarkColor: Colorz.BloodRed,
                inactiveTrackColor: Colorz.Facebook,
                minThumbSeparation: 10,
                overlappingShapeStrokeColor: Colorz.WhiteLingerie,
                overlayColor: Colorz.BabyBlueGlass,
                trackHeight: 15,
                thumbColor: Colorz.BlackBlack,
                showValueIndicator: ShowValueIndicator.always,
                valueIndicatorColor: Colorz.GreenPlastic,
              ...
              child: Slider(
                value: _theValue,
                activeColor: Colorz.YellowSmoke,
                autofocus: false,
