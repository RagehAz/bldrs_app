  ...
  Map<String, dynamic> _times (BuildContext context){
    ...
    return
        <String, dynamic>{
          ...
          'Timers.cipher to timeStamp' : Timers.cipherTime(time: _now, toJSON: false),
          ...
          'Timers.hourMinuteSecondListOfStrings([_now])' : Timers.hourMinuteSecondListOfStrings(<DateTime>[_now]),
          'Timers.hourMinuteSecondListOfStringsWithIndexes([_now], [0])' : Timers.hourMinuteSecondListOfStringsWithIndexes(<DateTime>[_now], <int>[0]),
