...
class NewMyBzScreen extends StatefulWidget {
  final TinyBz tinyBz;
  ...
  @override
  _NewMyBzScreenState createState() => _NewMyBzScreenState();
}

class _NewMyBzScreenState extends State<NewMyBzScreen> {
    ...
    return MainLayout(
      ...
      layoutWidget: bzModelStreamBuilder(
        ...
        builder: (ctx, bzModel){
          ...
          return
              // Header(
              //     flyerZoneWidth: superFlyerZoneWidth(context, 1),
              //     bzPageIsOn: false,
              //     tappingHeader: (){},
              //     tappingFollow: (){},
              //   stripBlurIsOn: false,
              //   tinyBz: TinyBz.getTinyBzFromBzModel(bzModel),
              //   tinyAuthor: AuthorModel.getTinyAuthorFromBzModel(
              //       bzModel : bzModel,
