...
// ---------------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      ...
      tappingRageh: () => slideBottomSheet(
        draggable: true,
        height: _flyerZoneWidth,
        context: context,
        child: Column(
          children: <Widget>[
  ...
  Widget _cameraPreviewWidget(double _cameraPreviewWidth, double _cameraPreviewHeight) {
    final CameraController cameraController = controller;
