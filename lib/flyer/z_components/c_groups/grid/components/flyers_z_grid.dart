...
import 'package:bldrs/flyer/z_components/a_light_flyer_structure/b_light_big_flyer.dart';
...
import 'package:bldrs/flyer/z_components/d_variants/c_add_flyer_button.dart';
import 'package:bldrs/flyer/z_components/d_variants/flyer_selection_stack.dart';
import 'package:bldrs/flyer/z_components/d_variants/small_flyer.dart';
    ...
    if (flyerModel != null) {
      ...
      if (_zoomedFlyer == null){
        ...
        await ZGridController.zoomIn(
          ...
          closeKeyboardFunction: Keyboard.closeKeyboard,
        );
      }
