import 'package:bldrs/a_models/e_notes/xxx_topic_event_work_space.dart';
...
class NootEvent {
  ...
  static const List<NootEvent> allEvent = <NootEvent>[
    ...
    NootEvent(
      ...
      channelID: savedFlyersChannelID,
    ...
    NootEvent(
      ...
      channelID: myBzzFlyersChannelID,
    ...
    NootEvent(
      ...
      channelID: myBzzFollowersChannelID,
    ...
    NootEvent(
      ...
      channelID: myBzzFlyersEngagementChannelID,
