  ...
  static String cipherActivity(Activity activity) {
    switch (activity) {
      ...
      case Activity.save:
        return 'save';
        break;
      case Activity.unSave:
        return 'unSave';
        break;
      case Activity.review:
        return 'review';
        break;
      case Activity.editReview:
        return 'editReview';
        break;
      case Activity.deleteReview:
        return 'deleteReview';
        break;
      case Activity.question:
        return 'question';
        break;
      case Activity.editQuestion:
        return 'editQuestion';
        break;
      case Activity.deleteQuestion:
        return 'deleteQuestion';
        break;
      case Activity.answer:
        return 'answer';
        break;
      case Activity.editAnswer:
        return 'editAnswer';
        break;
      case Activity.deleteAnswer:
        return 'deleteAnswer';
        break;
      default:
        return null;
  ...
  static Activity decipherActivity(String activity) {
    switch (activity) {
      ...
      case 'save':
        ...
        break;
      case 'unSave':
        return Activity.unSave;
        break;
      case 'review':
        return Activity.review;
        break;
      case 'editReview':
        return Activity.editReview;
        break;
      case 'deleteReview':
        return Activity.deleteReview;
        break;
      case 'question':
        return Activity.question;
        break;
      case 'editQuestion':
        return Activity.editQuestion;
        break;
      case 'deleteQuestion':
        return Activity.deleteQuestion;
        break;
      case 'answer':
        return Activity.answer;
        break;
      case 'editAnswer':
        return Activity.editAnswer;
        break;
      case 'deleteAnswer':
        return Activity.deleteAnswer;
        break;
      default:
        return null;
    }
