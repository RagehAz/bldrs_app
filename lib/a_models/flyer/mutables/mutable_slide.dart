  ...
  static MutableSlide getViewMutableSlideFromSlideModel(SlideModel slide) {
    ...
    return MutableSlide(
      ...
      descriptionController:
          null, //TextEditingController(text: slide.description),
      // -------------------------
...
// -----------------------------------------------------------------------------
  static Future<MutableSlide> getDraftMutableSlideFromSlideModel(
      SlideModel slide) async {
...
// -----------------------------------------------------------------------------
  static List<MutableSlide> getViewMutableSlidesFromSlidesModels(
      List<SlideModel> slides) {
    final List<MutableSlide> _slides = <MutableSlide>[];

    if (slides != null) {
      for (final SlideModel slide in slides) {
        final MutableSlide _mutableSlide =
            getViewMutableSlideFromSlideModel(slide);
...
// -----------------------------------------------------------------------------
  static Future<List<MutableSlide>> getDraftMutableSlidesFromSlidesModels(
    ...
    if (slides != null) {
      for (final SlideModel slide in slides) {
        final MutableSlide _mutableSlide =
            await getDraftMutableSlideFromSlideModel(slide);
...
// -----------------------------------------------------------------------------
  ...
  static int getAssetTrueIndexFromMutableSlides(
      {List<MutableSlide> mutableSlides, int slideIndex}) {
    int _trueIndex;
...
// -----------------------------------------------------------------------------
  static int getMutableSlideIndexThatContainsThisAsset(
      {List<MutableSlide> mSlides, Asset assetToSearchFor}) {
