...
// -----------------------------------------------------------------------------
    ...
    Flag(countryID: 'ala', icon: _ala,),
    Flag(countryID: 'alb', icon: _alb,),
    Flag(countryID: 'dza', icon: _dza,),
    Flag(countryID: 'asm', icon: _asm,),
    Flag(countryID: 'and', icon: _and,),
    Flag(countryID: 'ago', icon: _ago,),
    Flag(countryID: 'aia', icon: _aia,),
    Flag(countryID: 'atg', icon: _atg,),
    Flag(countryID: 'arg', icon: _arg,),
    Flag(countryID: 'arm', icon: _arm,),
    Flag(countryID: 'abw', icon: _abw,),
    Flag(countryID: 'aus', icon: _aus,),
    Flag(countryID: 'aut', icon: _aut,),
    Flag(countryID: 'aze', icon: _aze,),
    Flag(countryID: 'bhs', icon: _bhs,),
    Flag(countryID: 'bhr', icon: _bhr,),
    Flag(countryID: 'bgd', icon: _bgd,),
    Flag(countryID: 'brb', icon: _brb,),
    Flag(countryID: 'blr', icon: _blr,),
    Flag(countryID: 'bel', icon: _bel,),
    Flag(countryID: 'blz', icon: _blz,),
    Flag(countryID: 'ben', icon: _ben,),
    Flag(countryID: 'bmu', icon: _bmu,),
    Flag(countryID: 'btn', icon: _btn,),
    Flag(countryID: 'bol', icon: _bol,),
    Flag(countryID: 'bes', icon: _bes,),
    Flag(countryID: 'bih', icon: _bih,),
    Flag(countryID: 'bwa', icon: _bwa,),
    Flag(countryID: 'bvt', icon: _bvt,),
    Flag(countryID: 'bra', icon: _bra,),
    Flag(countryID: 'iot', icon: _iot,),
    Flag(countryID: 'brn', icon: _brn,),
    Flag(countryID: 'bgr', icon: _bgr,),
    Flag(countryID: 'bfa', icon: _bfa,),
    Flag(countryID: 'bdi', icon: _bdi,),
    Flag(countryID: 'cpv', icon: _cpv,),
    Flag(countryID: 'khm', icon: _khm,),
    Flag(countryID: 'cmr', icon: _cmr,),
    Flag(countryID: 'can', icon: _can,),
    Flag(countryID: 'cym', icon: _cym,),
    Flag(countryID: 'caf', icon: _caf,),
    Flag(countryID: 'tcd', icon: _tcd,),
    Flag(countryID: 'chl', icon: _chl,),
    Flag(countryID: 'chn', icon: _chn,),
    Flag(countryID: 'cxr', icon: _cxr,),
    Flag(countryID: 'cck', icon: _cck,),
    Flag(countryID: 'col', icon: _col,),
    Flag(countryID: 'com', icon: _com,),
    Flag(countryID: 'cog', icon: _cog,),
    Flag(countryID: 'cod', icon: _cod,),
    Flag(countryID: 'cok', icon: _cok,),
    Flag(countryID: 'cri', icon: _cri,),
    Flag(countryID: 'civ', icon: _civ,),
    Flag(countryID: 'hrv', icon: _hrv,),
    Flag(countryID: 'cub', icon: _cub,),
    Flag(countryID: 'cuw', icon: _cuw,),
    Flag(countryID: 'cyp', icon: _cyp,),
    Flag(countryID: 'cze', icon: _cze,),
    Flag(countryID: 'dnk', icon: _dnk,),
    Flag(countryID: 'dji', icon: _dji,),
    Flag(countryID: 'dma', icon: _dma,),
    Flag(countryID: 'dom', icon: _dom,),
    Flag(countryID: 'ecu', icon: _ecu,),
    Flag(countryID: 'egy', icon: _egy,),
    Flag(countryID: 'slv', icon: _slv,),
    Flag(countryID: 'gnq', icon: _gnq,),
    Flag(countryID: 'eri', icon: _eri,),
    Flag(countryID: 'est', icon: _est,),
    Flag(countryID: 'swz', icon: _swz,),
    Flag(countryID: 'eth', icon: _eth,),
    Flag(countryID: 'flk', icon: _flk,),
    Flag(countryID: 'fro', icon: _fro,),
    Flag(countryID: 'fji', icon: _fji,),
    Flag(countryID: 'fin', icon: _fin,),
    Flag(countryID: 'fra', icon: _fra,),
    Flag(countryID: 'guf', icon: _guf,),
    Flag(countryID: 'pyf', icon: _pyf,),
    Flag(countryID: 'atf', icon: _atf,),
    Flag(countryID: 'gab', icon: _gab,),
    Flag(countryID: 'gmb', icon: _gmb,),
    Flag(countryID: 'geo', icon: _geo,),
    Flag(countryID: 'deu', icon: _deu,),
    Flag(countryID: 'gha', icon: _gha,),
    Flag(countryID: 'gib', icon: _gib,),
    Flag(countryID: 'grc', icon: _grc,),
    Flag(countryID: 'grl', icon: _grl,),
    Flag(countryID: 'grd', icon: _grd,),
    Flag(countryID: 'glp', icon: _glp,),
    Flag(countryID: 'gum', icon: _gum,),
    Flag(countryID: 'gtm', icon: _gtm,),
    Flag(countryID: 'ggy', icon: _ggy,),
    Flag(countryID: 'gin', icon: _gin,),
    Flag(countryID: 'gnb', icon: _gnb,),
    Flag(countryID: 'guy', icon: _guy,),
    Flag(countryID: 'hti', icon: _hti,),
    Flag(countryID: 'hmd', icon: _hmd,),
    Flag(countryID: 'vat', icon: _vat,),
    Flag(countryID: 'hnd', icon: _hnd,),
    Flag(countryID: 'hkg', icon: _hkg,),
    Flag(countryID: 'hun', icon: _hun,),
    Flag(countryID: 'isl', icon: _isl,),
    Flag(countryID: 'ind', icon: _ind,),
    Flag(countryID: 'idn', icon: _idn,),
    Flag(countryID: 'irn', icon: _irn,),
    Flag(countryID: 'irq', icon: _irq,),
    Flag(countryID: 'irl', icon: _irl,),
    Flag(countryID: 'imn', icon: _imn,),
    Flag(countryID: 'isr', icon: _isr,),
    Flag(countryID: 'ita', icon: _ita,),
    Flag(countryID: 'jam', icon: _jam,),
    Flag(countryID: 'jpn', icon: _jpn,),
    Flag(countryID: 'jey', icon: _jey,),
    Flag(countryID: 'jor', icon: _jor,),
    Flag(countryID: 'kaz', icon: _kaz,),
    Flag(countryID: 'ken', icon: _ken,),
    Flag(countryID: 'kir', icon: _kir,),
    Flag(countryID: 'prk', icon: _prk,),
    Flag(countryID: 'kor', icon: _kor,),
    Flag(countryID: 'kwt', icon: _kwt,),
    Flag(countryID: 'kgz', icon: _kgz,),
    Flag(countryID: 'lao', icon: _lao,),
    Flag(countryID: 'lva', icon: _lva,),
    Flag(countryID: 'lbn', icon: _lbn,),
    Flag(countryID: 'lso', icon: _lso,),
    Flag(countryID: 'lbr', icon: _lbr,),
    Flag(countryID: 'lby', icon: _lby,),
    Flag(countryID: 'lie', icon: _lie,),
    Flag(countryID: 'ltu', icon: _ltu,),
    Flag(countryID: 'lux', icon: _lux,),
    Flag(countryID: 'mac', icon: _mac,),
    Flag(countryID: 'mdg', icon: _mdg,),
    Flag(countryID: 'mwi', icon: _mwi,),
    Flag(countryID: 'mys', icon: _mys,),
    Flag(countryID: 'mdv', icon: _mdv,),
    Flag(countryID: 'mli', icon: _mli,),
    Flag(countryID: 'mlt', icon: _mlt,),
    Flag(countryID: 'mhl', icon: _mhl,),
    Flag(countryID: 'mtq', icon: _mtq,),
    Flag(countryID: 'mrt', icon: _mrt,),
    Flag(countryID: 'mus', icon: _mus,),
    Flag(countryID: 'myt', icon: _myt,),
    Flag(countryID: 'mex', icon: _mex,),
    Flag(countryID: 'fsm', icon: _fsm,),
    Flag(countryID: 'mda', icon: _mda,),
    Flag(countryID: 'mco', icon: _mco,),
    Flag(countryID: 'mng', icon: _mng,),
    Flag(countryID: 'mne', icon: _mne,),
    Flag(countryID: 'msr', icon: _msr,),
    Flag(countryID: 'mar', icon: _mar,),
    Flag(countryID: 'moz', icon: _moz,),
    Flag(countryID: 'mmr', icon: _mmr,),
    Flag(countryID: 'nam', icon: _nam,),
    Flag(countryID: 'nru', icon: _nru,),
    Flag(countryID: 'npl', icon: _npl,),
    Flag(countryID: 'nld', icon: _nld,),
    Flag(countryID: 'ncl', icon: _ncl,),
    Flag(countryID: 'nzl', icon: _nzl,),
    Flag(countryID: 'nic', icon: _nic,),
    Flag(countryID: 'ner', icon: _ner,),
    Flag(countryID: 'nga', icon: _nga,),
    Flag(countryID: 'niu', icon: _niu,),
    Flag(countryID: 'nfk', icon: _nfk,),
    Flag(countryID: 'mkd', icon: _mkd,),
    Flag(countryID: 'mnp', icon: _mnp,),
    Flag(countryID: 'nor', icon: _nor,),
    Flag(countryID: 'omn', icon: _omn,),
    Flag(countryID: 'pak', icon: _pak,),
    Flag(countryID: 'plw', icon: _plw,),
    Flag(countryID: 'pse', icon: _pse,),
    Flag(countryID: 'pan', icon: _pan,),
    Flag(countryID: 'png', icon: _png,),
    Flag(countryID: 'pry', icon: _pry,),
    Flag(countryID: 'per', icon: _per,),
    Flag(countryID: 'phl', icon: _phl,),
    Flag(countryID: 'pcn', icon: _pcn,),
    Flag(countryID: 'pol', icon: _pol,),
    Flag(countryID: 'prt', icon: _prt,),
    Flag(countryID: 'pri', icon: _pri,),
    Flag(countryID: 'qat', icon: _qat,),
    Flag(countryID: 'reu', icon: _reu,),
    Flag(countryID: 'rou', icon: _rou,),
    Flag(countryID: 'rus', icon: _rus,),
    Flag(countryID: 'rwa', icon: _rwa,),
    Flag(countryID: 'blm', icon: _blm,),
    Flag(countryID: 'shn', icon: _shn,),
    Flag(countryID: 'kna', icon: _kna,),
    Flag(countryID: 'lca', icon: _lca,),
    Flag(countryID: 'maf', icon: _maf,),
    Flag(countryID: 'spm', icon: _spm,),
    Flag(countryID: 'vct', icon: _vct,),
    Flag(countryID: 'wsm', icon: _wsm,),
    Flag(countryID: 'smr', icon: _smr,),
    Flag(countryID: 'stp', icon: _stp,),
    Flag(countryID: 'sau', icon: _sau,),
    Flag(countryID: 'sen', icon: _sen,),
    Flag(countryID: 'srb', icon: _srb,),
    Flag(countryID: 'syc', icon: _syc,),
    Flag(countryID: 'sle', icon: _sle,),
    Flag(countryID: 'sgp', icon: _sgp,),
    Flag(countryID: 'sxm', icon: _sxm,),
    Flag(countryID: 'svk', icon: _svk,),
    Flag(countryID: 'svn', icon: _svn,),
    Flag(countryID: 'slb', icon: _slb,),
    Flag(countryID: 'som', icon: _som,),
    Flag(countryID: 'zaf', icon: _zaf,),
    Flag(countryID: 'sgs', icon: _sgs,),
    Flag(countryID: 'ssd', icon: _ssd,),
    Flag(countryID: 'esp', icon: _esp,),
    Flag(countryID: 'lka', icon: _lka,),
    Flag(countryID: 'sdn', icon: _sdn,),
    Flag(countryID: 'sur', icon: _sur,),
    Flag(countryID: 'sjm', icon: _sjm,),
    Flag(countryID: 'swe', icon: _swe,),
    Flag(countryID: 'che', icon: _che,),
    Flag(countryID: 'syr', icon: _syr,),
    Flag(countryID: 'twn', icon: _twn,),
    Flag(countryID: 'tjk', icon: _tjk,),
    Flag(countryID: 'tza', icon: _tza,),
    Flag(countryID: 'tha', icon: _tha,),
    Flag(countryID: 'tls', icon: _tls,),
    Flag(countryID: 'tgo', icon: _tgo,),
    Flag(countryID: 'tkl', icon: _tkl,),
    Flag(countryID: 'ton', icon: _ton,),
    Flag(countryID: 'tto', icon: _tto,),
    Flag(countryID: 'tun', icon: _tun,),
    Flag(countryID: 'tur', icon: _tur,),
    Flag(countryID: 'tkm', icon: _tkm,),
    Flag(countryID: 'tca', icon: _tca,),
    Flag(countryID: 'tuv', icon: _tuv,),
    Flag(countryID: 'uga', icon: _uga,),
    Flag(countryID: 'ukr', icon: _ukr,),
    Flag(countryID: 'are', icon: _are,),
    Flag(countryID: 'gbr', icon: _gbr,),
    Flag(countryID: 'usa', icon: _usa,),
    Flag(countryID: 'umi', icon: _umi,),
    Flag(countryID: 'ury', icon: _ury,),
    Flag(countryID: 'uzb', icon: _uzb,),
    Flag(countryID: 'vut', icon: _vut,),
    Flag(countryID: 'ven', icon: _ven,),
    Flag(countryID: 'vnm', icon: _vnm,),
    Flag(countryID: 'vgb', icon: _vgb,),
    Flag(countryID: 'vir', icon: _vir,),
    Flag(countryID: 'wlf', icon: _wlf,),
    Flag(countryID: 'esh', icon: _esh,),
    Flag(countryID: 'yem', icon: _yem,),
    Flag(countryID: 'zmb', icon: _zmb,),
    Flag(countryID: 'zwe', icon: _zwe,),
    Flag(countryID: 'euz', icon: _euz,),
    Flag(countryID: 'xks', icon: _xks,),
    Flag(countryID: 'afg', icon: _afg,),
...
// -----------------------------------------------------------------------------
  static const List<CountryIso> _allCountriesIsoCodes = <CountryIso>[
    CountryIso(countryID: 'afg', iso: 'af',),
    CountryIso(countryID: 'alb', iso: 'al',),
    CountryIso(countryID: 'dza', iso: 'dz',),
    CountryIso(countryID: 'asm', iso: 'as',),
    CountryIso(countryID: 'and', iso: 'ad',),
    CountryIso(countryID: 'ago', iso: 'ao',),
    CountryIso(countryID: 'atg', iso: 'ag',),
    CountryIso(countryID: 'arg', iso: 'ar',),
    CountryIso(countryID: 'arm', iso: 'am',),
    CountryIso(countryID: 'abw', iso: 'aw',),
    CountryIso(countryID: 'aus', iso: 'au',),
    CountryIso(countryID: 'aut', iso: 'at',),
    CountryIso(countryID: 'aze', iso: 'az',),
    CountryIso(countryID: 'bhs', iso: 'bs',),
    CountryIso(countryID: 'bhr', iso: 'bh',),
    CountryIso(countryID: 'bgd', iso: 'bd',),
    CountryIso(countryID: 'brb', iso: 'bb',),
    CountryIso(countryID: 'blr', iso: 'by',),
    CountryIso(countryID: 'bel', iso: 'be',),
    CountryIso(countryID: 'blz', iso: 'bz',),
    CountryIso(countryID: 'ben', iso: 'bj',),
    CountryIso(countryID: 'bmu', iso: 'bm',),
    CountryIso(countryID: 'btn', iso: 'bt',),
    CountryIso(countryID: 'bol', iso: 'bo',),
    CountryIso(countryID: 'bih', iso: 'ba',),
    CountryIso(countryID: 'bwa', iso: 'bw',),
    CountryIso(countryID: 'bra', iso: 'br',),
    CountryIso(countryID: 'brn', iso: 'bn',),
    CountryIso(countryID: 'bgr', iso: 'bg',),
    CountryIso(countryID: 'bfa', iso: 'bf',),
    CountryIso(countryID: 'mmr', iso: 'mm',),
    CountryIso(countryID: 'bdi', iso: 'bi',),
    CountryIso(countryID: 'cpv', iso: 'cv',),
    CountryIso(countryID: 'khm', iso: 'kh',),
    CountryIso(countryID: 'cmr', iso: 'cm',),
    CountryIso(countryID: 'can', iso: 'ca',),
    CountryIso(countryID: 'cym', iso: 'ky',),
    CountryIso(countryID: 'caf', iso: 'cf',),
    CountryIso(countryID: 'tcd', iso: 'td',),
    CountryIso(countryID: 'chl', iso: 'cl',),
    CountryIso(countryID: 'chn', iso: 'cn',),
    CountryIso(countryID: 'col', iso: 'co',),
    CountryIso(countryID: 'com', iso: 'km',),
    CountryIso(countryID: 'cog', iso: 'cg',),
    CountryIso(countryID: 'cod', iso: 'cd',),
    CountryIso(countryID: 'cok', iso: 'ck',),
    CountryIso(countryID: 'cri', iso: 'cr',),
    CountryIso(countryID: 'civ', iso: 'ci',),
    CountryIso(countryID: 'hrv', iso: 'hr',),
    CountryIso(countryID: 'cub', iso: 'cu',),
    CountryIso(countryID: 'cuw', iso: 'cw',),
    CountryIso(countryID: 'cyp', iso: 'cy',),
    CountryIso(countryID: 'cze', iso: 'cz',),
    CountryIso(countryID: 'dnk', iso: 'dk',),
    CountryIso(countryID: 'dji', iso: 'dj',),
    CountryIso(countryID: 'dma', iso: 'dm',),
    CountryIso(countryID: 'dom', iso: 'do',),
    CountryIso(countryID: 'ecu', iso: 'ec',),
    CountryIso(countryID: 'egy', iso: 'eg',),
    CountryIso(countryID: 'slv', iso: 'sv',),
    CountryIso(countryID: 'gnq', iso: 'gq',),
    CountryIso(countryID: 'eri', iso: 'er',),
    CountryIso(countryID: 'est', iso: 'ee',),
    CountryIso(countryID: 'eth', iso: 'et',),
    CountryIso(countryID: 'flk', iso: 'fk',),
    CountryIso(countryID: 'fro', iso: 'fo',),
    CountryIso(countryID: 'fji', iso: 'fj',),
    CountryIso(countryID: 'fin', iso: 'fi',),
    CountryIso(countryID: 'fra', iso: 'fr',),
    CountryIso(countryID: 'guf', iso: 'gf',),
    CountryIso(countryID: 'pyf', iso: 'pf',),
    CountryIso(countryID: 'gab', iso: 'ga',),
    CountryIso(countryID: 'gmb', iso: 'gm',),
    CountryIso(countryID: 'geo', iso: 'ge',),
    CountryIso(countryID: 'deu', iso: 'de',),
    CountryIso(countryID: 'gha', iso: 'gh',),
    CountryIso(countryID: 'gib', iso: 'gi',),
    CountryIso(countryID: 'grc', iso: 'gr',),
    CountryIso(countryID: 'grl', iso: 'gl',),
    CountryIso(countryID: 'grd', iso: 'gd',),
    CountryIso(countryID: 'glp', iso: 'gp',),
    CountryIso(countryID: 'gum', iso: 'gu',),
    CountryIso(countryID: 'gtm', iso: 'gt',),
    CountryIso(countryID: 'gin', iso: 'gn',),
    CountryIso(countryID: 'gnb', iso: 'gw',),
    CountryIso(countryID: 'guy', iso: 'gy',),
    CountryIso(countryID: 'hti', iso: 'ht',),
    CountryIso(countryID: 'hnd', iso: 'hn',),
    CountryIso(countryID: 'hkg', iso: 'hk',),
    CountryIso(countryID: 'hun', iso: 'hu',),
    CountryIso(countryID: 'isl', iso: 'is',),
    CountryIso(countryID: 'ind', iso: 'in',),
    CountryIso(countryID: 'idn', iso: 'id',),
    CountryIso(countryID: 'irn', iso: 'ir',),
    CountryIso(countryID: 'irq', iso: 'iq',),
    CountryIso(countryID: 'irl', iso: 'ie',),
    CountryIso(countryID: 'imn', iso: 'im',),
    CountryIso(countryID: 'isr', iso: 'il',),
    CountryIso(countryID: 'ita', iso: 'it',),
    CountryIso(countryID: 'jam', iso: 'jm',),
    CountryIso(countryID: 'jpn', iso: 'jp',),
    CountryIso(countryID: 'jey', iso: 'je',),
    CountryIso(countryID: 'jor', iso: 'jo',),
    CountryIso(countryID: 'kaz', iso: 'kz',),
    CountryIso(countryID: 'ken', iso: 'ke',),
    CountryIso(countryID: 'kir', iso: 'ki',),
    CountryIso(countryID: 'prk', iso: 'kp',),
    CountryIso(countryID: 'kor', iso: 'kr',),
    CountryIso(countryID: 'xks', iso: 'xk',),
    CountryIso(countryID: 'kwt', iso: 'kw',),
    CountryIso(countryID: 'kgz', iso: 'kg',),
    CountryIso(countryID: 'lao', iso: 'la',),
    CountryIso(countryID: 'lva', iso: 'lv',),
    CountryIso(countryID: 'lbn', iso: 'lb',),
    CountryIso(countryID: 'lso', iso: 'ls',),
    CountryIso(countryID: 'lbr', iso: 'lr',),
    CountryIso(countryID: 'lby', iso: 'ly',),
    CountryIso(countryID: 'lie', iso: 'li',),
    CountryIso(countryID: 'ltu', iso: 'lt',),
    CountryIso(countryID: 'lux', iso: 'lu',),
    CountryIso(countryID: 'mac', iso: 'mo',),
    CountryIso(countryID: 'mkd', iso: 'mk',),
    CountryIso(countryID: 'mdg', iso: 'mg',),
    CountryIso(countryID: 'mwi', iso: 'mw',),
    CountryIso(countryID: 'mys', iso: 'my',),
    CountryIso(countryID: 'mdv', iso: 'mv',),
    CountryIso(countryID: 'mli', iso: 'ml',),
    CountryIso(countryID: 'mlt', iso: 'mt',),
    CountryIso(countryID: 'mhl', iso: 'mh',),
    CountryIso(countryID: 'mtq', iso: 'mq',),
    CountryIso(countryID: 'mrt', iso: 'mr',),
    CountryIso(countryID: 'mus', iso: 'mu',),
    CountryIso(countryID: 'myt', iso: 'yt',),
    CountryIso(countryID: 'mex', iso: 'mx',),
    CountryIso(countryID: 'fsm', iso: 'fm',),
    CountryIso(countryID: 'mda', iso: 'md',),
    CountryIso(countryID: 'mco', iso: 'mc',),
    CountryIso(countryID: 'mng', iso: 'mn',),
    CountryIso(countryID: 'mne', iso: 'me',),
    CountryIso(countryID: 'mar', iso: 'ma',),
    CountryIso(countryID: 'moz', iso: 'mz',),
    CountryIso(countryID: 'nam', iso: 'na',),
    CountryIso(countryID: 'npl', iso: 'np',),
    CountryIso(countryID: 'nld', iso: 'nl',),
    CountryIso(countryID: 'ncl', iso: 'nc',),
    CountryIso(countryID: 'nzl', iso: 'nz',),
    CountryIso(countryID: 'nic', iso: 'ni',),
    CountryIso(countryID: 'ner', iso: 'ne',),
    CountryIso(countryID: 'nga', iso: 'ng',),
    CountryIso(countryID: 'mnp', iso: 'mp',),
    CountryIso(countryID: 'nor', iso: 'no',),
    CountryIso(countryID: 'omn', iso: 'om',),
    CountryIso(countryID: 'pak', iso: 'pk',),
    CountryIso(countryID: 'plw', iso: 'pw',),
    CountryIso(countryID: 'pan', iso: 'pa',),
    CountryIso(countryID: 'png', iso: 'pg',),
    CountryIso(countryID: 'pry', iso: 'py',),
    CountryIso(countryID: 'per', iso: 'pe',),
    CountryIso(countryID: 'phl', iso: 'ph',),
    CountryIso(countryID: 'pol', iso: 'pl',),
    CountryIso(countryID: 'prt', iso: 'pt',),
    CountryIso(countryID: 'pri', iso: 'pr',),
    CountryIso(countryID: 'qat', iso: 'qa',),
    CountryIso(countryID: 'reu', iso: 're',),
    CountryIso(countryID: 'rou', iso: 'ro',),
    CountryIso(countryID: 'rus', iso: 'ru',),
    CountryIso(countryID: 'rwa', iso: 'rw',),
    CountryIso(countryID: 'shn', iso: 'sh',),
    CountryIso(countryID: 'kna', iso: 'kn',),
    CountryIso(countryID: 'lca', iso: 'lc',),
    CountryIso(countryID: 'vct', iso: 'vc',),
    CountryIso(countryID: 'wsm', iso: 'ws',),
    CountryIso(countryID: 'smr', iso: 'sm',),
    CountryIso(countryID: 'stp', iso: 'st',),
    CountryIso(countryID: 'sau', iso: 'sa',),
    CountryIso(countryID: 'sen', iso: 'sn',),
    CountryIso(countryID: 'srb', iso: 'rs',),
    CountryIso(countryID: 'syc', iso: 'sc',),
    CountryIso(countryID: 'sle', iso: 'sl',),
    CountryIso(countryID: 'sgp', iso: 'sg',),
    CountryIso(countryID: 'svk', iso: 'sk',),
    CountryIso(countryID: 'svn', iso: 'si',),
    CountryIso(countryID: 'slb', iso: 'sb',),
    CountryIso(countryID: 'som', iso: 'so',),
    CountryIso(countryID: 'zaf', iso: 'za',),
    CountryIso(countryID: 'sgs', iso: 'gs',),
    CountryIso(countryID: 'ssd', iso: 'ss',),
    CountryIso(countryID: 'esp', iso: 'es',),
    CountryIso(countryID: 'lka', iso: 'lk',),
    CountryIso(countryID: 'sdn', iso: 'sd',),
    CountryIso(countryID: 'sur', iso: 'sr',),
    CountryIso(countryID: 'swz', iso: 'sz',),
    CountryIso(countryID: 'swe', iso: 'se',),
    CountryIso(countryID: 'che', iso: 'ch',),
    CountryIso(countryID: 'syr', iso: 'sy',),
    CountryIso(countryID: 'twn', iso: 'tw',),
    CountryIso(countryID: 'tjk', iso: 'tj',),
    CountryIso(countryID: 'tza', iso: 'tz',),
    CountryIso(countryID: 'tha', iso: 'th',),
    CountryIso(countryID: 'tls', iso: 'tl',),
    CountryIso(countryID: 'tgo', iso: 'tg',),
    CountryIso(countryID: 'ton', iso: 'to',),
    CountryIso(countryID: 'tto', iso: 'tt',),
    CountryIso(countryID: 'tun', iso: 'tn',),
    CountryIso(countryID: 'tur', iso: 'tr',),
    CountryIso(countryID: 'tkm', iso: 'tm',),
    CountryIso(countryID: 'tca', iso: 'tc',),
    CountryIso(countryID: 'tuv', iso: 'tv',),
    CountryIso(countryID: 'uga', iso: 'ug',),
    CountryIso(countryID: 'ukr', iso: 'ua',),
    CountryIso(countryID: 'are', iso: 'ae',),
    CountryIso(countryID: 'gbr', iso: 'gb',),
    CountryIso(countryID: 'usa', iso: 'us',),
    CountryIso(countryID: 'ury', iso: 'uy',),
    CountryIso(countryID: 'uzb', iso: 'uz',),
    CountryIso(countryID: 'vut', iso: 'vu',),
    CountryIso(countryID: 'vat', iso: 'va',),
    CountryIso(countryID: 'ven', iso: 've',),
    CountryIso(countryID: 'vnm', iso: 'vn',),
    CountryIso(countryID: 'wlf', iso: 'wf',),
    CountryIso(countryID: 'pse', iso: 'xw',),
    CountryIso(countryID: 'yem', iso: 'ye',),
    CountryIso(countryID: 'zmb', iso: 'zm',),
    CountryIso(countryID: 'zwe', iso: 'zw',),
  ];
// -----------------------------------------------------------------------------
}
