...
// BLDRS COLORS
  ...
  static const BlackBlack = Color.fromARGB(1000, 0, 0, 0);
  static const DarkBlack = Color.fromARGB(1000, 6, 6, 15);
  ...
  static const DarkBlue = Color.fromARGB(1000, 20, 20, 80);
  static const BabyBlue = Color.fromARGB(1000, 133, 203, 218);
  ...
  static const LightBlue = Color.fromARGB(1000, 201, 232, 239);
  ...
  static const BloodRed = Color.fromARGB(1000, 233, 0, 0);
  ...
  static const DarkRed = Color.fromARGB(1000, 118, 33, 33);
  static const DarkRedPlastic = Color.fromARGB(plasticOpacity, 118, 33, 33);

  static const Green = Color.fromARGB(1000, 24, 157, 14);
  ...
  static const DarkGreen = Color.fromARGB(1000, 10, 80, 20);

  static const White = Color.fromARGB(1000, 255, 255, 255);
  ...
  static const Grey = Color.fromARGB(1000, 200, 200, 200);
  ...
  static const LightGrey = Color.fromARGB(1000, 220, 220, 220);

  static const Facebook = Color.fromARGB(1000, 59, 89, 152);
  static const LinkedIn = Color.fromARGB(1000, 0, 115, 176);
