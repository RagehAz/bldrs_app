...
import 'package:bldrs/b_views/widgets/specific/flyer/parts/pages_parts/slides_page_parts/footer_parts/slide_counters.dart';
...
// -----------------------------------------------------------------------------
  static double buttonMargin({
    ...
    final double _footerBTMargins = (_buttonIsOn == true && _tinyMode == true)
        ? //&& widget.slidingIsOn == false
...
// -----------------------------------------------------------------------------
    ...
    final double _flyerFooterHeight =
        boxHeight(context: context, flyerBoxWidth: flyerBoxWidth);
