...
// -----------------------------------------------------------------------------
    ...
    final double gridFlyerWidth = widget.gridZoneWidth /
        (widget.numberOfColumns +
            (widget.numberOfColumns * spacingRatioToGridWidth) +
            spacingRatioToGridWidth);
    ...
    final double gridHeight = gridFlyerHeight *
        (_numOfRows +
            (_numOfRows * spacingRatioToGridWidth) +
            spacingRatioToGridWidth);
...
// -----------------------------------------------------------------------------
    final double _flyerSizeFactor =
        ((widget.gridZoneWidth - (gridSpacing * (gridColumnsCount + 1))) /
                gridColumnsCount) /
            screenWidth;
// -----------------------------------------------------------------------------
