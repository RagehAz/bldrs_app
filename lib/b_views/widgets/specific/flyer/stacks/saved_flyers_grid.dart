                          ...
                          children: <Widget>[
                            ...
                            if (_isSelected == true)
                              DreamBox(
                                ...
                                corners: Borderers.superFlyerCorners(
                                    context, _flyerBoxWidth),
                              ),
                            if (_isSelected == true)
                              Container(
                                width: _flyerBoxWidth,
                            ...
                            if (_isSelected == true)
                              Container(
                                ...
                                height:
                                    FlyerBox.height(context, _flyerBoxWidth),
                                alignment: Aligners.superInverseBottomAlignment(
                                    context),
                                ...
                                child: DreamBox(
                                  height: FlyerBox.bottomCornerValue(
                                          _flyerBoxWidth) *
                                      2,
                                  width: FlyerBox.bottomCornerValue(
                                          _flyerBoxWidth) *
                                      2,
                                  corners: FlyerBox.bottomCornerValue(
                                      _flyerBoxWidth),
