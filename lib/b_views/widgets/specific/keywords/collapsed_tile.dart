...
import 'package:bldrs/b_views/widgets/general/chain_expander/components/expanding_tile.dart';
...
class CollapsedTile extends StatelessWidget {
  ...
  /// --------------------------------------------------------------------------
  static Widget arrow(
      {double collapsedHeight, Color arrowColor, bool arrowDown = true}) {
...
// -----------------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    final double _titlePadding =
        icon == null ? Ratioz.appBarMargin * 2 : Ratioz.appBarMargin;
    ...
    return Container(
      ...
      margin: marginIsOn == true
          ? const EdgeInsets.symmetric(
              vertical: Ratioz.appBarPadding, horizontal: Ratioz.appBarMargin)
          : null,
                  ...
                  if (icon != null)
                    DreamBox(
                      height: ExpandingTile.calculateTitleIconSize(
                          icon: icon, collapsedHeight: collapsedHeight),
                  ...
                  Container(
                    width: ExpandingTile.calculateTitleBoxWidth(
                        collapsedHeight: collapsedHeight ??
                            CollapsedTile.collapsedGroupHeight,
                        tileWidth: tileWidth,
                        icon: icon),
                    height:
                        collapsedHeight ?? CollapsedTile.collapsedGroupHeight,
