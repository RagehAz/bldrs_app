  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsets _barPadding = appIsLeftToRight(context) == true
        ? const EdgeInsets.only(
            left: Ratioz.appBarPadding, right: _selectedKeywordsZoneHeight)
        : const EdgeInsets.only(
            left: _selectedKeywordsZoneHeight, right: Ratioz.appBarPadding);
            ...
            child: selectedKeywords.isEmpty
                ...
                : ScrollablePositionedList.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) {
                      final KW _keyword =
                          index >= 0 ? selectedKeywords[index] : null;
