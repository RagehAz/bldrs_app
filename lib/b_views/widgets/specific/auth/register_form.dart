...
// -----------------------------------------------------------------------------
  Future<void> _registerOnTap({ZoneModel currentZone}) async {
    ...
    if (_allFieldsAreValid() == true) {
      ...
      blog(
          '_registerOnTap() _result.runtimeType : ${_result.runtimeType} : $_result');
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFieldBubble(
            ...
            fieldIsFormField: true,
            fieldIsRequired: true,
            keyboardTextInputType: TextInputType
                .visiblePassword, // ----------------------------------------------------------
            keyboardTextInputAction: TextInputAction.next,
          ...
          TextFieldBubble(
            ...
            keyboardTextInputType: TextInputType
                .visiblePassword, // ----------------------------------------------------------
            keyboardTextInputAction: TextInputAction
                .done, // ----------------------------------------------------------
