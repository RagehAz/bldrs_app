...
// -----------------------------------------------------------------------------
  void _onBubbleTap() {
    blog(
        '_onBubbleTap : noti id is : ${notiModel.id} : ${notiModel.timeStamp} : dif : ${Timers.getTimeDifferenceInSeconds(from: notiModel.timeStamp, to: DateTime.now())}');
  }
...
// -----------------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    final bool _notiHasButtons =
        notiModel?.attachmentType == NotiAttachmentType.buttons;
                        ...
                        children: <Widget>[
                          ...List<Widget>.generate(notiModel.attachment.length,
                            ...
                            return DreamBox(
                              ...
                              onTap: () =>
                                  _onButtonTap(notiModel.attachment[index]),
                            );
                          }),
                        ],
                      ),
