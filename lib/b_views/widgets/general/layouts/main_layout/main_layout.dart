...
// -----------------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    final Color _backgroundColor =
        skyType == SkyType.non || skyType == SkyType.black
            ? Colorz.blackSemi255
            : Colorz.skyDarkBlue;
          ...
          children: <Widget>[
            ...
            Scaffold(
              ...
              resizeToAvoidBottomInset:
                  false, // this false prevents keyboard from pushing pyramids up
...
class Stratosphere extends StatelessWidget {
  ...
  /// --------------------------------------------------------------------------
  static const EdgeInsets stratosphereInsets =
      EdgeInsets.only(top: Ratioz.stratosphere);
  static const EdgeInsets stratosphereSandwich =
      EdgeInsets.only(top: Ratioz.stratosphere, bottom: Ratioz.stratosphere);
  ...
  static const double smallAppBarStratosphere =
      Ratioz.appBarSmallHeight + _margins;

  /// --------------------------------------------------------------------------
  @override
  Widget build(BuildContext context) {
    final double _height =
        bigAppBar == true ? bigAppBarStratosphere : smallAppBarStratosphere;
