...
class MultipleChoiceBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Bubble(bubbleColor: Colorz.white10, columnChildren: <Widget>[
      SuperVerse(
        verse: title,
        margin: 5,
        redDot: true,
      ...
      Wrap(
          ...
          children: List<Widget>.generate(buttonsList.length, (int index) {
            ...
            return DreamBox(
              ...
              color: chosenButton == buttonsList[index]
                  ? Colorz.yellow255
                  : Colorz.white10,
              verseColor: chosenButton == buttonsList[index]
                  ? Colorz.black230
                  : Colorz.white255,
              verseWeight: chosenButton == buttonsList[index]
                  ? VerseWeight.black
                  : VerseWeight.bold,
