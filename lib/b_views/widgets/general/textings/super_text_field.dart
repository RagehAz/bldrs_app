...
// -----------------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    final double _verseSize =
        SuperVerse.superVerseSizeValue(context, _size, _scalingFactor);
    ...
    final double _verseLetterSpacing =
        SuperVerse.superVerseLetterSpacing(_weight, _verseSize);

    /// --- WORD SPACING -----------------------------------------------
    final double _verseWordSpacing =
        SuperVerse.superVerseWordSpacing(_verseSize);
    ...
    final double _shadowXOffset =
        SuperVerse.superVerseXOffset(_weight, _verseSize);
    ...
    final Color _rightShadow =
        widget.inputColor == Colorz.black230 ? Colorz.white80 : Colorz.white20;
    ...
    final double _labelCornerValues =
        SuperVerse.superVerseLabelCornerValue(context, _size);
    ...
    final double _sidePaddingValues =
        SuperVerse.superVerseSidePaddingValues(context, _size);
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    final InputDecoration _inputDecoration = InputDecoration(
      ...
      focusedBorder:
          Borderers.superOutlineInputBorder(Colorz.yellow80, _labelCorner),
      enabledBorder:
          Borderers.superOutlineInputBorder(Colorz.nothing, _labelCorner),
      ...
      errorBorder:
          Borderers.superOutlineInputBorder(Colorz.red125, _labelCorner),
      border: Borderers.superOutlineInputBorder(Colorz.linkedIn, _labelCorner),
      disabledBorder:
          Borderers.superOutlineInputBorder(Colorz.grey255, _labelCorner),
      counterText:
...
// -----------------------------------------------------------------------------
    final TextAlign _textAlign =
        widget.centered == true ? TextAlign.center : TextAlign.start;
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    return widget.fieldIsFormField == true
        ?
