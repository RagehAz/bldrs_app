...
class PropertySearchCriteria extends StatelessWidget {
  ...
  /// --------------------------------------------------------------------------
  static Future<void> openEnumLister(Map<String, Object> map) async {
    Mapper.blogMap(map, methodName: 'PropertySearchCriteria');
  }
  // -----------------------------------------------------------------------------
  @override
            ...
            Column(
              ...
              children: <Widget>[
                ...
                FieldsRow(
                  ...
                  titleVerse: Verse.plain(propertyUseMap['Title']),
                  fieldsVerses: Verse.createVerses(strings: propertyUseMap['Strings'], translate: false),
                ),

                /// --- PROPERTY TYPE
                FieldsRow(
                  openList: () => openEnumLister(propertyTypeMap),
                  titleVerse: Verse.plain(propertyTypeMap['Title']),
                  fieldsVerses: Verse.createVerses(strings: propertyTypeMap['Strings'], translate: false),
                ),

                /// --- CONTRACT TYPE
                FieldsRow(
                  openList: () => openEnumLister(contractTypeMap),
                  titleVerse: Verse.plain(contractTypeMap['Title']),
                  fieldsVerses: Verse.createVerses(strings: contractTypeMap['Strings'], translate: false),
                ),
                ...
                FieldsRow(
                  ...
                  titleVerse: Verse.plain('Location of property'),
                  fieldsVerses: Verse.createVerses(strings: <String>['Heliopolis', 'Cairo', 'Egypt'], translate: false),
                ),
