...
class XOLDBzEditorScreenView extends StatelessWidget {
  /// --------------------------------------------------------------------------
  const XOLDBzEditorScreenView({
          ...
          return ListView(
            ...
            children: <Widget>[
              ...
              ValueListenableBuilder(
                  ...
                  builder: (_, BzSection selectedSection, Widget child){
                    ...
                    return MultipleChoiceBubble(
                      ...
                      isInError: false,
                      onButtonTap: (int index) => oldOnSelectBzSection(
                        context: context,
                        index: index,
                    ...
                    return ValueListenableBuilder(
                        ...
                        builder: (_, List<BzType> inactiveTypes, Widget child){
                          ...
                          return MultipleChoiceBubble(
                            ...
                            isInError: false,
                            onButtonTap: (int index) => oldOnSelectBzType(
                              context: context,
                              index: index,
                              selectedBzForm: selectedBzForm,
                              inactiveBzForms: inactiveBzForms,
                    ...
                    return ValueListenableBuilder(
                      ...
                      builder: (_, List<BzForm> inactiveBzForms, Widget child){
                        ...
                        return MultipleChoiceBubble(
                          ...
                          inactiveButtons: _inactiveButtons,
                          isInError: false,
                          onButtonTap: (int index) => oldOnSelectBzForm(
                            index: index,
                            selectedBzForm: selectedBzForm,
                          ),
                        );
              ...
              OldAddImagePicBubble(
                ...
                onAddPicture: (ImagePickerType imagePickerType) => oldTakeBzLogo(
                  context: context,
                  bzLogo: bzLogo,
              ...
              ValueListenableBuilder(
                  ...
                  builder: (_, ZoneModel bzZone, Widget child){
                    ...
                    return ZoneSelectionBubble(
                      ...
                      currentZone: bzZone,
                      onZoneChanged: (ZoneModel zone) => oldOnBzZoneChanged(
                        zoneModel: zone,
