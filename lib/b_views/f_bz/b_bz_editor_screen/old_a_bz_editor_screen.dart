...
import 'package:bldrs/b_views/f_bz/b_bz_editor_screen/old_aa_bz_editor_screen_view.dart';
...
class XOLDBzEditorScreen extends StatefulWidget {
  /// --------------------------------------------------------------------------
  const XOLDBzEditorScreen({
  ...
  /// --------------------------------------------------------------------------
  @override
  _XOLDBzEditorScreenState createState() => _XOLDBzEditorScreenState();
  /// --------------------------------------------------------------------------
}

class _XOLDBzEditorScreenState extends State<XOLDBzEditorScreen> with TickerProviderStateMixin {
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      ...
      layoutWidget: XOLDBzEditorScreenView(
        formKey: _formKey,
        missingFields: _missingFields,
