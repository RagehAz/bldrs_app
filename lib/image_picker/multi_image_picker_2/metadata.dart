...
class ExifMetadata {
  ...
  ExifMetadata.fromMap(Map json)
      : imageWidth = _castAsDouble(json['ImageWidth']),
        ...
        _castAsDouble(json['JPEGInterchangeFormat']),
        ...
        _castAsDouble(json['PrimaryChromaticities']),
        ycbCrCoefficients = _castAsDouble(json['YCbCrCoefficients']),
        referenceBlackWhite =
        _castAsDouble(json['ReferenceBlackWhite']),
        ...
        _castAsDouble(json['CompressedBitsPerPixel']),
        ...
        subSecTimeDigitized =
        _castAsString(json['SubSecTimeDigitized']),
        ...
        spectralSensitivity =
        _castAsString(json['SpectralSensitivity']),
        photographicSensitivity =
        _castAsInt(json['PhotographicSensitivity']),
        ...
        isoSpeedLatitudeyyy =
        _castAsDouble(json['ISOSpeedLatitudeyyy']),
        isoSpeedLatitudezzz =
        _castAsDouble(json['ISOSpeedLatitudezzz']),
        ...
        _castAsDouble(json['FocalPlaneXResolution']),
        focalPlaneYResolution =
        _castAsDouble(json['FocalPlaneYResolution']),
        focalPlaneResolutionUnit =
        _castAsInt(json['FocalPlaneResolutionUnit']),
        ...
        _castAsInt(json['FocalLengthIn35mmFilm']),
...
class GpsMetadata {
  ...
  GpsMetadata.fromMap(Map json)
      : gpsVersionID = _castAsString(json['GPSVersionID']),
        ...
        gpsDestLongitudeRef =
        _castAsString(json['GPSDestLongitudeRef']),
        ...
        gpsProcessingMethod =
        _castAsString(json['GPSProcessingMethod']),
        ...
        _castAsDouble(json['GPSHPositioningError']),
        interoperabilityIndex =
        _castAsString(json['InteroperabilityIndex']);
