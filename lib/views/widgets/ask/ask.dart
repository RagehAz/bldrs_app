...
class _AskState extends State<Ask> {
  ...
  Future<void> _addAskPic() async {
    final _imageFile = await takeGalleryPicture(PicType.askPic);
...
// ---------------------------------------------------------------------------
    ...
    double gridZoneWidth = superBubbleClearWidth(context);
        ...
        Row(
          ...
          children: <Widget>[
            ...
            DreamBox(
              height: 40,
              // width: 40,
              boxMargins: EdgeInsets.only(top: 10),
