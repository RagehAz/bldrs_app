...
class AskModel {
  ...
  Map<String, dynamic> toMap(){
    ...
    'userID' : userID,
    'askBody' : askBody,
    'askType' : FlyerTypeClass.cipherFlyerType(askType),
...
AskModel decipherAskMap(Map<String, dynamic> map){
  return AskModel(
      ...
      userID: map['userID'],
      askBody: map['askBody'],
      askType: FlyerTypeClass.decipherFlyerType(map['askType']),
      askTime: map['askTime'],
...
ChatModel decipherChatMap(Map<String, dynamic> map){
  return ChatModel(
    ...
    author1 : AuthorModel.decipherBzAuthorMap(map['author1']),
    author2 : AuthorModel.decipherBzAuthorMap(map['author2']),
    userID : map['userID'],
