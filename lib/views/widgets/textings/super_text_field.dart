...
class SuperTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    VerseWeight weight = inputWeight;
    ...
    Color leftShadow = inputColor == Colorz.BlackBlack ? Colorz.WhitePlastic : Colorz.BlackBlack;
    Color rightShadow = inputColor == Colorz.BlackBlack ? Colorz.WhiteSmoke : Colorz.WhiteGlass;
    ...
    return Container(
      width: width,
      height: height,
      padding: EdgeInsets.only(bottom: counterIsOn == true ? sidePaddings : 0),
      ...
      child: TextField(
        ...
        style: superTextStyle(inputColor, 1),
        enabled: true, // THIS DISABLES THE ABILITY TO OPEN THE KEYBOARD
        minLines: minLines,
        maxLines: obscured == true ? 1 : maxLines,
        maxLength: maxLength,
        ...
        decoration: InputDecoration(
          ...
          counter: counterIsOn ? null : Offstage(),
