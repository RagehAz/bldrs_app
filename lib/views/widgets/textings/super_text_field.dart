...
class _SuperTextFieldState extends State<SuperTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    double verseSize = (size == 0) ? screenHeight * Ratioz.fontSize0 * scalingFactor // -- 8 -- A77A
    ...
    FontWeight verseWeigher(VerseWeight weight){
      return
              weight == VerseWeight.thin ? FontWeight.w100
            : weight == VerseWeight.regular ? FontWeight.w600
            : weight == VerseWeight.bold ? FontWeight.w100
    ...
    // --- AVAILABLE FONTS -----------------------------------------------
    String verseFont = weight ==
        VerseWeight.thin ? getTranslated(context, 'Body_Font')
    ...
    double labelCornerValues = (size == 0) ? screenHeight * Ratioz.fontSize0 * labelCornerRatio // -- 8 -- A77A
    ...
    double sidePaddingValues = (size == 0) ? screenHeight * Ratioz.fontSize0 * sidePaddingRatio // -- 8 -- A77A
    ...
    TextStyle superHintStyle(Color textColor, double sizeFactor) {
      return TextStyle(
          ...
          wordSpacing: verseWordSpacing,
          fontSize: verseSize * sizeFactor,
          fontWeight: verseWeigher(VerseWeight.thin),
          shadows: [],
      );
    }
