...
class TheChainPickerScreen extends StatefulWidget {
  // --------------------------------------------------------------------------
  const TheChainPickerScreen({
    super.key
  });
  // --------------------
  ///
  // --------------------
  @override
  _TheChainPickerScreenState createState() => _TheChainPickerScreenState();
  // --------------------------------------------------------------------------
...
class _TheChainPickerScreenState extends State<TheChainPickerScreen> {
  // -----------------------------------------------------------------------------
  /// --- LOADING
