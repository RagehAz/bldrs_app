...
// -----------------------------------------------------------------------------
Zone hatlyBzZone(String bzID){
  BzModel _bz = geebBzByBzID(bzID);
  Zone _zone = Zone.getZoneFromBzModel(_bz);
  return _zone;
}
// -----------------------------------------------------------------------------
int hatlyFollowers(String bzID){
  BzModel _bz = geebBzByBzID(bzID);
  return _bz.bzTotalFollowers;
}
// -----------------------------------------------------------------------------
int hatlyFlyersCount(String bzID){
  BzModel _bz = geebBzByBzID(bzID);
  int _flyersCount = _bz.bzFlyers.length;
  return _flyersCount;
}
// -----------------------------------------------------------------------------
