...
// -----------------------------------------------------------------------------
  static List<dynamic> cipherMessages(
      {@required List<MessageModel> messages, @required bool toJSON}) {
...
// -----------------------------------------------------------------------------
  static MessageModel decipherMessage(
      {@required Map<String, dynamic> msgMap, @required bool fromJSON}) {
    return MessageModel(
...
// -----------------------------------------------------------------------------
  static List<MessageModel> decipherMessages(
      {@required List<Map<String, dynamic>> msgsMaps,
...
// -----------------------------------------------------------------------------
  static List<MessageModel> addToMessages({
    ...
    final List<MessageModel> _newMessages = <MessageModel>[
      ...existingMsgs,
      _newMessage
    ];
