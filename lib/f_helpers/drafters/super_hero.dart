...
//   static Rect fromHeroLocation(_HeroState fromHero, PageRoute<dynamic> fromRoute){
//     return _boundingBoxFor(fromHero.context, fromRoute.subtreeContext);
//   }
//
...
//   /// [_HeroFlight.divert].
//   static Rect toHeroLocation(_HeroState toHero, PageRoute<dynamic> toRoute){
//     return _boundingBoxFor(toHero.context, toRoute.subtreeContext);
//   }
//
...
//   static bool isValid(_HeroState fromHero, PageRoute<dynamic> fromRoute, bool isDiverted, ){
//
//     final Rect _fromHeroLocation = fromHeroLocation(fromHero, fromRoute);
//
//     final bool _isValid = _fromHeroLocation.isFinite && (isDiverted || _fromHeroLocation.isFinite);
//     return _isValid;
//   }
//
//   @override
//   String toString() {
//
//     final bool _isValid = isValid(fromHero, fromRoute, isDiverted);
//
//     return '_HeroFlightManifest($type tag: $tag from route: ${fromRoute.settings} '
//         'to route: ${toRoute.settings} with hero: $fromHero to $toHero)${_isValid ? '' : ', INVALID'}';
//   }
// }
//
...
//     }
//
//     final Rect _fromHeroLocation = fromHeroLocation();
//
//     heroRectTween = manifest.createHeroRectTween(begin: manifest._fromHeroLocation, end: manifest.toHeroLocation);
