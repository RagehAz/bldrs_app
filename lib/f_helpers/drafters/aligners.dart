...
Alignment superInverseTopAlignment(BuildContext context) {
  return appIsLeftToRight(context) ? Alignment.topRight : Alignment.topLeft;
}
...
double rightPositionInLeftAlignmentEn(
    BuildContext context, double offsetFromRight) {
  double _rightOffset;
...
double leftPositionInLeftAlignmentEn(
    BuildContext context, double offsetFromLeft) {
  double _leftOffset;
...
double rightPositionInRightAlignmentEn(
    BuildContext context, double offsetFromRight) {
...
double leftPositionInRightAlignmentEn(
    BuildContext context, double offsetFromLeft) {
