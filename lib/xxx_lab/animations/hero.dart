...
class AboHero extends StatelessWidget {
  ...
  Widget _stupidFlightShuttle(flightContext, animation, direction, fromContext, toContext) {
    ...
    final double _flyerSmallWidth = FlyerBox.width(fromContext, 0.4);
    final double _flyerBigWidth = FlyerBox.width(fromContext, 1);
  ...
  Widget _flyerShuttle (
    ...
    final double _flyerBoxWidth = FlyerBox.width(fromHeroContext, sizeFactor);
