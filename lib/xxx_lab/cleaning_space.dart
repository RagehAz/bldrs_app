...
// -----------------------------------------------------------------------------
List<List<int>> addIndexesToFinalListIfPossible(
    List<int> toAdd, List<List<int>> finalList) {
...
bool finalListContainsIndexes(List<int> toAdd, List<List<int>> finalList) {
  ...
  if (Mapper.canLoopList(finalList)) {
    for (int i = 0; i < finalList.length; i++) {
      ...
      final bool _foundMatch =
          Mapper.listsAreTheSame(list1: _list, list2: toAdd);
...
// -----------------------------------------------------------------------------
List<String> getStringsFromPermutationIndexesList(
    {String source, List<List<int>> indexesList}) {
...
int getNumberOfCombinations({
  ...
  final int _denominator =
      getFactorial(number - _selected) * getFactorial(_selected);
